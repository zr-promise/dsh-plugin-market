window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function MarketPage(props) {
      ...
      // 打开已装插件详情：有仓库则拉取 GitHub 详情（README/清单），无仓库只显示本地信息
      ...
      function renderManageDetail() {
        ...
        var rows = [];
        rows.push(React.createElement("button", { key: "back", className: "dshm-btn dshm-back", onClick: function () { setManageSelected(null); setManageDetail(null); } }, "← 返回已装插件"));
        ...
        rows.push(React.createElement("div", { key: "actions", className: "dshm-manage-actions" },
          ...
          p.referenced === false
            ...
            : React.createElement("button", { className: "dshm-btn dshm-btn-danger" + (uninstallArm === p.name ? " dshm-btn-primary" : ""), disabled: manageBusy, onClick: function () { doUninstall(p.name); } }, uninstallArm === p.name ? "确认卸载？（含源码）" : "卸载")
        ));
      ...
      function renderManage() {
          ...
          rows.push(React.createElement("div", { key: p.name, className: "dshm-manage-row dshm-card", onClick: function () { openManageDetail(p); } },
            ...
            React.createElement("div", { className: "dshm-manage-actions" },
              ...
              p.referenced === false
                ...
                : React.createElement("button", { className: "dshm-btn dshm-btn-danger" + (uninstallArm === p.name ? " dshm-btn-primary" : ""), disabled: manageBusy, onClick: function (e) { if (e) e.stopPropagation(); doUninstall(p.name); } }, uninstallArm === p.name ? "确认卸载？（含源码）" : "卸载")
            )
          ));
        });
        if (rows.length === 0) {
        ...
        return React.createElement("div", { className: "dshm-list" },
          React.createElement("div", { className: "dshm-manage-head" },
            ...
            manageMsg ? React.createElement("span", { className: manageMsg.ok ? "dshm-ok" : "dshm-error" }, manageMsg.text) : null
          ),
          rows
        );
      }
      ...
      function renderDetail() {
        ...
        rows.push(React.createElement("button", { key: "install", className: "dshm-btn dshm-btn-primary", disabled: !!install, onClick: doInstall },
      ...
      return React.createElement("div", { className: "dshm" },
        React.createElement("div", { className: "dshm-tabs" },
          ...
          React.createElement("button", { className: "dshm-tab" + (view === "manage" ? " dshm-tab-active" : ""), onClick: function () { setView("manage"); if (managed === null) loadManage(); } }, "已装插件")
        ),
